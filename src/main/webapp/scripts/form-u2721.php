...
{
	$to = 'enquiry@smileyrhyme.com';
	$subject = 'ch. contact Form 送出';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>您的名字:</b></td><td>' . htmlentities($_REQUEST["custom_U2732"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>电子邮件地址:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>信息:</b></td><td>' . htmlentities($_REQUEST["custom_U2727"],ENT_COMPAT,'UTF-8') . '</td></tr>';
